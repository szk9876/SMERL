...
class HopperVelocityObstaclesEnv(MujocoEnv, MultitaskEnv, Serializable):
    ...
    @property
    def model_name(self):
        return get_asset_full_path('classic_mujoco/hopper_obstacles/hopper_obstacle_position={}_height={}.xml'.format(self.obstacle_position, self.obstacle_height))
