...
class AntVelocityJointsEnv(MujocoEnv, MultitaskEnv, Serializable):
    def __init__(self, action_scale=1, frame_skip=5, force=None, timestep_start=100000, timestep_end=100000):
        ...
        print('Timestep Start: ', timestep_start)
        print('Timestep End: ', timestep_end) 
    ...
    def step(self, a):
        ...
        current_velocity = torso_velocity[0]/self.dt
        if current_velocity > 5:
            forward_reward = 5.
        else:
            forward_reward = current_velocity
