# Ant Goal Environment with negative reward + terminal when falling.
...
class AntGoalFallingEnv(MultitaskAntEnv):
    def __init__(self, n_tasks=1, randomize_tasks=False, action_scale=1, frame_skip=5, goal_position=5):
        ...
        super(AntGoalFallingEnv, self).__init__(n_tasks=n_tasks, action_scale=action_scale, frame_skip=frame_skip)
