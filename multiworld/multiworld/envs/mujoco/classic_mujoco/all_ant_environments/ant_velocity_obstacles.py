...
class AntVelocityObstaclesEnv(MujocoEnv, MultitaskEnv, Serializable):
    ...
    @property
    def model_name(self):
        return get_asset_full_path('classic_mujoco/ant_obstacles/ant_obstacle_position={}_height={}.xml'.format(self.obstacle_position, self.obstacle_height))
