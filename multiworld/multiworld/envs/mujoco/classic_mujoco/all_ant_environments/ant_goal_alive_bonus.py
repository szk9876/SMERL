# Ant Goal Environment with negative reward + terminal when falling + alive bonus.
...
class AntGoalAliveBonusEnv(MultitaskAntEnv):
    def __init__(self, n_tasks=1, randomize_tasks=False, action_scale=1, frame_skip=5, goal_position=5):
        ...
        super(AntGoalAliveBonusEnv, self).__init__(n_tasks=n_tasks, action_scale=action_scale, frame_skip=frame_skip)
    ...
    def step(self, action):
        ...
        done = goal_reward > -0.5 or not notdone
