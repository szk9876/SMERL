...
from multiworld.envs.mujoco.classic_mujoco.walker_environments.walker2d_velocity_motor import WalkerVelocityMotorFailureEnv
...
def simulate_policy(args):
    ...
    for action in range(10, 110, 10):  # (3, 9)
        if args.env_name == 'WalkerVelocity':
            wrapped_env = gym.make('WalkerVelocityMotorFailure-v{}'.format(action))
            disc = data['env'].disc
