...
from multiworld.envs.mujoco.classic_mujoco.all_hopper_environments.hopper_velocity_joints import HopperVelocityDisabledJointsEnv
...
def simulate_policy(args):
    ...
    for joint in range(1, 20):
        if args.env_name == 'HopperVelocity':
            wrapped_env = gym.make('HopperVelocityDisabledJoints-v{}'.format(joint))
            disc = data['env'].disc
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='sac', required=True)
