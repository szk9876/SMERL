...
def _estimate_gaussian_covariances_full(resp, X, nk, means, reg_covar):
    ...
    # covariances1 = covariances
    # t1 = time.time()

    covariances = torch.Tensor(n_components, n_features, n_features).cuda()
    ...
    # t2 = time.time()
    # print(t2 - t1, t1 - t0, np.allclose(covariances, covariances1))

    # if not np.allclose(covariances, covariances1):
